...
export default function Home() {
	...
	return (
		<>
			...
			<div className={`${styles.background} px-8 md:px-32 py-4 relative`}>
				...
				<div className="flex flex-col md:flex-row mt-20 items-center justify-evenly">
					<Card className="bg-[#111112] border-none text-white w-64 text-center py-10">
						<CardHeader>
					...
					<Card className="bg-[#111112] border-none text-white w-64 text-center py-10 mt-8 md:mt-0">
						<CardHeader>
							<div className="flex w-full justify-center">
								<Avatar className="z-30 w-14 h-14">
